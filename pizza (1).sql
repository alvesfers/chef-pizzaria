...
--
ALTER TABLE `tb_adicional`
  ADD CONSTRAINT `fk_adicional_tipo` FOREIGN KEY (`id_tipo_adicional`) REFERENCES `tb_tipo_adicional` (`id_tipo_adicional`) ON DELETE CASCADE;

--
-- Restrições para tabelas `tb_combo_item`
--
ALTER TABLE `tb_combo_item`
  ADD CONSTRAINT `fk_comboitem_combo` FOREIGN KEY (`id_combo`) REFERENCES `tb_combo_promocional` (`id_combo`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_comboitem_prod` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`) ON DELETE CASCADE;

--
-- Restrições para tabelas `tb_item_pedido`
--
ALTER TABLE `tb_item_pedido`
  ADD CONSTRAINT `fk_itempedido_combo` FOREIGN KEY (`id_combo`) REFERENCES `tb_combo_promocional` (`id_combo`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_itempedido_pedido` FOREIGN KEY (`id_pedido`) REFERENCES `tb_pedido` (`id_pedido`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_itempedido_produto` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`) ON DELETE SET NULL;

--
-- Restrições para tabelas `tb_pedido`
--
ALTER TABLE `tb_pedido`
  ADD CONSTRAINT `fk_pedido_cupom` FOREIGN KEY (`id_cupom`) REFERENCES `tb_cupom` (`id_cupom`) ON DELETE SET NULL;

--
-- Restrições para tabelas `tb_produto`
--
ALTER TABLE `tb_produto`
  ADD CONSTRAINT `fk_produto_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tb_categoria` (`id_categoria`) ON DELETE SET NULL;

--
-- Restrições para tabelas `tb_produto_adicional_incluso`
--
ALTER TABLE `tb_produto_adicional_incluso`
  ADD CONSTRAINT `fk_prod_inc_adicional` FOREIGN KEY (`id_adicional`) REFERENCES `tb_adicional` (`id_adicional`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_prod_inc_prod` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`) ON DELETE CASCADE;

--
-- Restrições para tabelas `tb_produto_tipo_adicional`
--
ALTER TABLE `tb_produto_tipo_adicional`
  ADD CONSTRAINT `fk_prod_tipo_prod` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_prod_tipo_tipo` FOREIGN KEY (`id_tipo_adicional`) REFERENCES `tb_tipo_adicional` (`id_tipo_adicional`) ON DELETE CASCADE;

--
-- Restrições para tabelas `tb_subcategoria_categoria`
--
ALTER TABLE `tb_subcategoria_categoria`
  ADD CONSTRAINT `fk_subcat_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tb_categoria` (`id_categoria`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_subcat_subcategoria` FOREIGN KEY (`id_subcategoria`) REFERENCES `tb_subcategoria` (`id_subcategoria`) ON DELETE CASCADE;

--
-- Restrições para tabelas `tb_tipo_adicional_categoria`
--
ALTER TABLE `tb_tipo_adicional_categoria`
  ADD CONSTRAINT `fk_tipo_cat_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tb_categoria` (`id_categoria`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_tipo_cat_tipo` FOREIGN KEY (`id_tipo_adicional`) REFERENCES `tb_tipo_adicional` (`id_tipo_adicional`) ON DELETE CASCADE;
COMMIT;
